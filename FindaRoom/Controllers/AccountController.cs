...
namespace FindaRoom.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginIndexViewModel model, string returnUrl)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(LoginIndexViewModel model)
        {
            if (ModelState.IsValid)
            {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        var user = new ApplicationUser { UserName = loginInfo.ExternalIdentity.FindFirstValue(ClaimTypes.Name), Email = loginInfo.Email };
        ...
        public async Task<ActionResult> FacebookInfo()
        {
            ...
            var fbId = myInfo.data;
            var friendsList = new List<FbInfo>();
            foreach (dynamic friend in myInfo.data)
            {

                friendsList.Add(new FbInfo()
                {
                    name = friend.name,
